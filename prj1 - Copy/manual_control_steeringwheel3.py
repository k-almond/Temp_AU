...
class CameraManager(object):
    def __init__(self, parent_actor, hud):
        ...
        self._camera_transforms = [
            carla.Transform(carla.Location(x=-5.5, z=2.8), carla.Rotation(pitch=-15)),  # Rear camera
            carla.Transform(carla.Location(x=1.6, z=1.7)),  # Dashboard view
            carla.Transform(carla.Location(x=-1.0, z=1.7), carla.Rotation(yaw=-45)),  # Left mirror
            carla.Transform(carla.Location(x=1.0, z=1.7), carla.Rotation(yaw=45)),  # Right mirror
        ]
